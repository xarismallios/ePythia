        ...
        {step === 'welcome' && (
          <div className="animate-fade-in space-y-8">
            ...
            <section className="max-w-2xl mx-auto pt-8 text-center">
              ...
              <h1 className="font-headline font-bold text-primary text-[2.5rem] md:text-[3rem] leading-[1.1] tracking-tight mb-4">
                {t.heroLine1}<br />
                {t.heroLine2} <span className="text-secondary">{t.heroLine3}</span>
              </h1>
              {t.heroMission && (
                <p className="text-sm text-on-surface-variant leading-relaxed max-w-xl mx-auto mb-8">{t.heroMission}</p>
              )}
