    ...
    return (
      <div className="space-y-5">
        {sections.map((sec, si) => {
          ...
          const isRoadmap = tl.includes('επόμεν') || tl.includes('βήμα') || (si === sections.length - 1 && (sec.items.length > 0 || sec.subs.length > 0));
          const isSkills  = tl.includes('δεξιότ') || tl.includes('ικανότ') || tl.includes('skill');
          ...
          <div className="w-full max-w-md animate-fade-in bg-surface rounded-2xl shadow-2xl border border-outline-variant/20 p-8" onClick={e => e.stopPropagation()}>
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                {authSubmitting ? 'Παρακαλώ περίμενε...' : authMode === 'login' ? t.authLoginBtn : t.authSignupBtn}
              </button>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
            ...
            <div className="flex flex-col gap-5 mb-14 max-w-xl mx-auto w-full">
              ...
              <div className="flex items-center gap-4 p-5 rounded-xl border border-dashed border-primary/30 bg-primary/5">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-on-surface-variant mt-0.5">Γνωστικό ερωτηματολόγιο, AI roadmap & premium PDF. <span className="font-semibold text-secondary">{t.comingSoon}.</span></p>
                </div>
              </div>
            </div>
        ...
        {step === 'highschool-type-select' && (
          <div className="max-w-4xl mx-auto animate-fade-in">
            <div className="text-center mb-12"><h2 className="text-4xl font-headline font-bold text-primary mb-4">{t.selectHighschoolTitle}</h2><p className="text-on-surface-variant">Διάλεξε για να λάβεις προσαρμοσμένες ερωτήσεις</p></div>
        ...
        {step === 'employee-sector-select' && (
          <div className="max-w-4xl mx-auto animate-fade-in">
            <div className="text-center mb-12"><h2 className="text-4xl font-headline font-bold text-primary mb-4">{t.selectSectorTitle}</h2><p className="text-on-surface-variant">Διάλεξε για να λάβεις προσαρμοσμένες ερωτήσεις</p></div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="max-w-2xl mx-auto animate-fade-in">
            <div className="mb-10">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm text-on-surface-variant font-label">Ερώτηση <span className="text-primary font-bold">{currentQuestionIndex + 1}</span> {t.questionOf} {totalQuestions}</span>
